...
namespace Webzine.EntitiesContext.Seeders
{
    ...
    /// <summary>
    /// Classe statique pour initialiser les données de seed dans le contexte de base de données.
    /// </summary>
    public static class SeedDataLocal
    {
        /// <summary>
        /// Initialise les données de seed dans le contexte de la base de données.
        /// </summary>
        ...
        {
            // Désactivez le suivi des changements pour améliorer les performances lors du seeding.
            context.ChangeTracker.QueryTrackingBehavior = QueryTrackingBehavior.NoTracking;

            // Ajoutez les ensembles de données au contexte.
            ...
            // Enregistrez les changements dans la base de données après le seeding.
            context.SaveChanges();
        }
    }
}